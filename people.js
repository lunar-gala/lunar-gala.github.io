...
window.onload = function() {
  $('.Gallery-content').each(function(e) {
      var assetNum = Math.floor(Math.random() * 3) + 1;
      $(this).append("<div class='frame-top' style='background-image:url(people-assets/" + assetNum +".png)'></div>");
      $(this).append("<div class='headshot' style='background-image:url(HEADSHOTS/" + (e+1) +".jpg)'></div>");
  });
}
